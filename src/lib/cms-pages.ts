...
export const CMS_PAGES: CmsPage[] = [
  {
    ...
    defaultTitle: 'Home',
    description:
      'Every band on the homepage. The hero wording and the newsletter blurb are in Settings; the photographs and film in the hero wall are the Forum gallery and Forum videos collections in Media.',
    routes: ['/'],
    blocks: [
      {
        key: 'sectorsEyebrow',
      ...
      { key: 'sectorsTitle', label: 'Sectors — heading', kind: 'line', max: 90 },
      {
        key: 'sectorsLead',
        label: 'Sectors — standfirst',
        kind: 'prose',
        rows: 2,
      },
      { key: 'dealRoomEyebrow', label: 'Deal Room — eyebrow', kind: 'line', max: 40 },
      { key: 'dealRoomTitle', label: 'Deal Room — heading', kind: 'line', max: 90 },
      { key: 'dealRoomLead', label: 'Deal Room — standfirst', kind: 'prose', rows: 3 },
      {
        key: 'dealRoomApplyLabel',
        label: 'Deal Room — first button',
        hint: 'Goes to the funding application. Two or three words.',
        kind: 'line',
        max: 40,
      },
      {
        key: 'dealRoomBrowseLabel',
        label: 'Deal Room — second button',
        hint: 'Goes to the list of opportunities.',
        kind: 'line',
        max: 40,
      },
      ...
      },
      {
        ...
        hint: 'The paragraph under it is the newsletter blurb in Settings.',
        kind: 'line',
        max: 90,
      },
    ],
